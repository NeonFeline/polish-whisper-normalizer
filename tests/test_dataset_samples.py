...
@pytest.mark.parametrize("text, expected", [
    ...
    ("później zabroniła ruszać się z miejsc światła same pogasły", "później zabroniła ruszać się z miejsc światła same pogasły"),
    # Azon – scientific, number
    ("energia wzbudzenia pułapkowana umożliwia przeprowadzenie fotochemicznej reakcji", "energia wzbudzenia pułapkowana umożliwia przeprowadzenie fotochemicznej reakcji"),
